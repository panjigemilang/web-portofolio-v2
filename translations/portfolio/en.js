const enPortfolioTranslations = {
  devkami: {
    ...
    descriptionOne:
      "This is my first web apps working as a fullstack engineer. Dev Kami is a website to connects developer all around the world. This website has functionality like the following :",
    functions: [
  ...
  ptpnx: {
    ...
    descriptionOne:
      "I was doing internship as a Fullstack website developer. I'm working at the PTPN X Djoembang Baru company, Jombang, East Java for 3 months. PT Perkebunan Nusantara (PTPN) is the name of fourteen state-owned companies operating in the plantation sector throughout Indonesia. \nI was assigned to make a full-stack website to be used as internal company needs. This website has functionality like the following :",
    functions: [
      "Authentication with token",
  ...
  kampungDesa: {
    ...
    descriptionOne:
      "On July 27, 2019 I created a team of 5 members to build a software house that provides making a website and android apps. Desa Cerdas Bersahaja is our first project, this website used for the introduction of a new village for common purposes. \nI was assigned to be a full-stack engineer. This website has functionality like the following :",
    functions: [
      "Authentication with token",
      "Create a post",
    ...
    descriptionTwo:
      "There was a little problem on the process like clients need keep changing, miss-communication with the team. But finally we can manage it to finished it without problem.",
    technologyIntro:
      "This project was built using the following programming languages and frameworks : ",
    technologies: [
      "Javascript",
  ...
  hoping: {
    ...
    descriptionOne:
      "On 24 February, 2019 I'm going to Osaka, Japan for 2 months internship program. This is my first time going abroad and especially it's Japan, after a long time I dreamed of going to Japan since I was in high school.",
    descriptionTwo:
      "I'm working on Hoping company, a company that providing software where you can use with loyalty and always being a trusted company. Mostly the company providing a software for a hospital needs, like dialysis record, bed management, patient comprehensive information, etc. I was assigned to be a software engineer to build a desktop apps, a little bit different from my past experiences.",
    descriptionThree:
    ...
    descriptionFour:
      "There was a time when we were going to a hospital to meet the client. It was a new hospital that just open, so we are given the task to examining rooms and thinking of an appropriate location to install computers and internet network. I learned a lot of things from this experience.",
    descriptionFive:
      "Unfortunately, because of the corona outbreak going really bad at that time I must go back earlier than the scheduled. So it was 5 weeks in total. I got a lot of memories that I will never forget. \nSee you later, Japan.",
    imageCaptions: {
  ...
  fkhapps: {
    ...
    descriptionOne:
      "Me and my team got a project from the Brawijaya University Faculty of Veterinary Medicine. We build a responsive and progressive web apps for the Veterinary Professional Education thesis. I was assigned to be front-end engineer.",
    descriptionTwo:
    ...
    outro:
      "This application will be released in September 2020 and ready to be used for the user.",
    imageCaptions: {
      login: "Login Page",
  ...
  iniDiaLo: {
    ...
    descriptionOne:
      "Inidialo is a blog website. This is my personal project to make a blog website for my father. He wanted to share his experiences about everything, any life lessons he had, or just a common knowledge to share. This website currently has functionality like the following :",
    functions: [
      "Authentication with token",
  ...
  kaneKashite: {
    ...
    descriptionTwo:
      "\\It's really helpful for us as we going to a lot of trips together! It's not even a trip, sometimes just paying someones food or drinks, or even just a movie or concert ticket. It's just a simple app that can help us keep track of our expenses and make it easier to share the cost of the trip.",
    technologyIntro:
      "This project was built using the following programming languages and frameworks : ",
    technologies: [
      "Typescript",
    ...
    outro:
      "\\It's a lot of funs to make this app as I progress to keep expanding the needed features, there could be more features in the future!",
    imageCaptions: {
      src: "Kane Kashite - Split Bill App",
      src2: "Kane Kashite - Add Trip Item",
      src3: "Kane Kashite - Details Trip Item",
    },
  },
  opsileave: {
    title: "Opsileave",
